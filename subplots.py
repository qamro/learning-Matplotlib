...
# NOTE: the subplots() function returns two values: the figure and the axes(subplots) of the subplots we created
# NOTE: the axes is a 2D array of the subplots we created, so we can access each subplot by its index in the array
